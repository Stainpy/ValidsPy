...
def work_input():
    work_list = print(colors.normal +"""
 +----+-------------+----------------------------+
 | 1  | Origin      | https://origin.com         |
 -------------------------------------------------
 | 2  | Soundcloud  | https://soundcloud.com     |
 -------------------------------------------------
 | 3  | Activision  | https://activision.com     |
 -------------------------------------------------
 ...
 | 6  | Viu         | https://viu.com            |
 -------------------------------------------------
 | 7  | Spotify     | https://spotify.com        |
 -------------------------------------------------
 | 8  | Uplay       | https://ubisoftconnect.com |
 -------------------------------------------------
 | 9  | Godaddy     | https://godaddy.com        |
 +----+-------------+----------------------------+  """)
